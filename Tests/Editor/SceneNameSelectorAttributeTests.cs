...
{
    /// <summary>
    ///     SceneNameSelectorAttributeがシーン名フィルター名の指定を公開する契約を検証する。
    /// </summary>
    public sealed class SceneNameSelectorAttributeTests
    {
        /// <summary>
        ...
        {
            SceneNameSelectorAttribute attribute = new();
        ...
        {
            SceneNameSelectorAttribute attribute = new("IsSelectable");
        ...
        {
            AttributeUsageAttribute usage = typeof(SceneNameSelectorAttribute)
