...
namespace SymphonyFrameWork.Samples.DebuggerSample
{
    ...
    public sealed class DebuggerSample_Controller : MonoBehaviour
    {
        ...
        {
            SymphonyDebugLogger.LogDirect("DebuggerSampleからの通常ログです。", LogKindEnum.Normal, this);
        ...
        {
            SymphonyDebugLogger.LogDirect("DebuggerSampleからの警告ログです。", LogKindEnum.Warning, this);
        ...
        {
            SymphonyDebugLogger.LogDirect("DebuggerSampleからのエラーログです。", LogKindEnum.Error, this);
        ...
        public void FlushLogText()
        {
            ...
            SymphonyDebugLogger.LogText(LogKindEnum.Normal, clearText: true, context: this);
