...
{
    /// <summary> ロードするシーン名とActive Scene選択用の優先度を表す。 </summary>
    public readonly struct SceneLoadRequest : IEquatable<SceneLoadRequest>
    {
        /// <summary> ロード対象と優先度を指定してリクエストを生成する。 </summary>
        ...
        /// <summary> 2つのリクエストが同じシーン名と優先度を持つか判定する。 </summary>
        ...
        /// <summary> 2つのリクエストが異なるシーン名または優先度を持つか判定する。 </summary>
        /// <param name="left"> 左辺のリクエスト。 </param>
        /// <param name="right"> 右辺のリクエスト。 </param>
        ...
        /// <summary> 指定したリクエストと同値か判定する。 </summary>
        ...
        /// <summary> シーン名と優先度に基づくハッシュコードを返す。 </summary>
