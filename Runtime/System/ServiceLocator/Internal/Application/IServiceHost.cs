...
{
    /// <summary> ApplicationからUnity上のサービス所有処理を分離する境界。 </summary>
    internal interface IServiceHost
    {
        /// <summary> Singleton登録されたComponentを所有階層へ接続する。 </summary>
        /// <param name="instance"> 登録されたpayload。 </param>
        void Attach(object instance);

        /// <summary> 登録解除されたComponentを所有階層から切り離す。 </summary>
        /// <param name="instance"> 登録解除されたpayload。 </param>
        void Detach(object instance);

        /// <summary> IDisposableまたはComponentとしてpayloadを解放する。 </summary>
