...
{
    /// <summary>
    ///     ApplicationからUnityのScene操作を利用するための最小契約。
    /// </summary>
    internal interface ISceneLoader
    {
        ...
        /// <summary>
        ///     指定したロード済みSceneをActive Sceneにする。
        /// </summary>
        /// <param name="sceneName"> シーン名。 </param>
        ...
        /// <summary>
        ///     ロード済みSceneのルートObjectへ依存注入と非同期初期化を行う。
        /// </summary>
        /// <param name="sceneName"> シーン名。 </param>
